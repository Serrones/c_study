...
stored in a register instead of RAM. This means that the variable has a maximum
size equal to the register size (usually one word) and can't have the unary '&'
...
it causes that variable's scope to be restricted to the file in which it is
declared.
